...
We wrote our compiler using Dart because it both had good tooling, it allowed
	us to start writing code without concering ourselves with \fix{Makefiles},
	and it was close to C++ (with the option to ignore types).
Because of it's simplicity, our compiler and parser were just \fix{5000} lines of code.